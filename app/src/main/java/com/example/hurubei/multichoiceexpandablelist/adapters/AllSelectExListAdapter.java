 ...
 * Created on 16/8/16.
 */
public class AllSelectExListAdapter extends BaseExpandableListAdapter implements ExpandableListView.OnChildClickListener {
    ...
    public AllSelectExListAdapter(Context context, List<GroupItem> parent, Map<GroupItem, List<ChildItem>> child, List<ChildItem> selectedItems, CheckBox allSelected) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        groupHolder.groupBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                allSelected.setChecked(isAllSelected);
            }
        });
        return convertView;
    }
